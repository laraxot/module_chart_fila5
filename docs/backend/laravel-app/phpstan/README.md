# Documentazione Analisi PHPStan

La documentazione dettagliata sull'analisi PHPStan per i moduli Laravel è stata spostata nel modulo core Xot:

➡️ [Vai a Modules/Xot/docs/phpstan/README.md](../../Modules/Xot/docs/phpstan/README.md)

Consulta sempre la documentazione aggiornata nel modulo Xot per le best practice e le linee guida sull'analisi statica.
