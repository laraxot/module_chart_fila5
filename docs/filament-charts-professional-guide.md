# Professional Charts in Filament 4: Complete Implementation Guide

**Created:** January 2026
**Framework:** Filament 4.0.20, Laravel 12.31
...
Create a chart widget extending Filament's `ChartWidget`:
...
### Filament 4 ChartWidget: feature ufficiali da usare nel progetto

Riferimento ufficiale:

- [Chart widgets - Filament 4](https://filamentphp.com/docs/4.x/widgets/charts)
...
#### Plugin Chart.js (es. datalabels) via Vite

Filament permette di registrare plugin Chart.js tramite:

- `window.filamentChartJsPlugins`
- `window.filamentChartJsGlobalPlugins`

Strategia consigliata: file JS dedicato (es. `resources/js/filament-chart-js-plugins.js`) incluso nel `vite.config.js`.
