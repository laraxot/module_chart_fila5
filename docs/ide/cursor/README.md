# Impostazioni Cursor per il progetto

## Panoramica
Questo documento descrive le impostazioni standard di Cursor per il progetto il progetto.
...
### 1. Formattazione
- Utilizzare Prettier per JS/TS/Vue
- PHP CS Fixer per PHP
- Blade Formatter per template

### 2. Linting
- ESLint per JavaScript
- PHP_CodeSniffer per PHP
- StyleLint per CSS/SCSS

### 3. Debug
- Xdebug per PHP
- Chrome DevTools per JS
- Vue DevTools per Vue
...
- [Xot Module](../../../laravel/Modules/Xot/docs/development.md)
- [UI Module](../../../laravel/Modules/UI/docs/development.md)

## Manutenzione

### 1. Aggiornamenti
- Mantenere le estensioni aggiornate
