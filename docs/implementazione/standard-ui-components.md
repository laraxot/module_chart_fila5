...
> **Nota**: Questo documento è sincronizzato con [/laravel/Modules/Cms/docs/standard_ui_components.md](../../laravel/Modules/Cms/docs/standard_ui_components.md)
> 
> Per modifiche, aggiornare questo file e sincronizzare le modifiche nella copia.
